    ...
    <Container id="Project">
      <InnerDiv>
        ...
        <SubContainer id="IS-Portfolio">
          <ButtonContainer id="IS-Portfolio-Header" onClick={(e) => ButtonClick("IS-Portfolio")}>
        ...
        <SubContainer id="IS-Telegram">
          <ButtonContainer id="IS-Telegram-Header" onClick={(e) => ButtonClick("IS-Telegram")}>
        ...
        <SubContainer id="CNS-Lotte">
          <ButtonContainer id="CNS-Lotte-Header" onClick={(e) => ButtonClick("CNS-Lotte")}>
        ...
        <SubContainer id="CNS-Coupang">
          <ButtonContainer id="CNS-Coupang-Header" onClick={(e) => ButtonClick("CNS-Coupang")}>
        ...
        <SubContainer id="ITM-Brandmall">
          <ButtonContainer id="ITM-Brandmall-Header" onClick={(e) => ButtonClick("ITM-Brandmall")}>
        ...
        <SubContainer id="ITM-NBOS">
          <ButtonContainer id="ITM-NBOS-Header" onClick={(e) => ButtonClick("ITM-NBOS")}>
        ...
        <SubContainer id="S&AT-Messenger">
          <ButtonContainer id="S&AT-Messenger-Header" onClick={(e) => ButtonClick("S&AT-Messenger")}>
        ...
        <ButtonContainer id="IS-NFC-Header" onClick={(e) => ButtonClick("IS-NFC")}>
