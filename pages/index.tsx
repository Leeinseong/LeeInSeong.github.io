  ...
  //Tier.J
  {
    ...
    projectList: [
      ...
      },
      {
        ...
        projectType: "신규",
        title:
          "정기 구독 플랫폼(다독) 판매자, 관리자 렌더링 웹 페이지 개발 프로젝트",
        ...
        management: "Git, Notion, Docker, Jenkins",
        description:
          "정기구독 플랫폼 (다독) - 렌더링, 판매자, 관리자 웹 페이지 기획 및 개발",
        role:
          "- 판매자 페이지 ( 상품, 구독, 주문, 결제, 리뷰) 개발\n" +
      ...
      },
      {
        ...
        management: "Git, Notion, Docker, Jenkins",
        description:
          "가오픈 매장들을 모아 관리해주고 방문 혜택 쿠폰을 발행하여 홍보를 해주는 서비스 개발",
        role:
          "- App 기획 및 개발, API 개발\n" +
          "- 가게 카테고리 및 지역별 분류 개발\n" +
    ...
    projectList: [
      {
        ...
        management: "Git",
        description:
          "롯데마트의 스마트스토어(바로배송 + 예약배송 + 픽업)과 세미다크(예약배송 + 픽업)에서 피킹완료부터 출하장까지 분류를 자동화 시스템",
        role:
          "- 관리자 화면 및 패킹 및 검수 프로그램 개발(WCS)\n" +
      ...
      },
      {
        ...
        management: "Git",
        description:
          "쿠팡 물류창고의 컨베이어 소터, 휠소터를 통한 자동 분류 소터 시스템 구축",
        role:
          "- 관리자 화면 및 물류 분류 관리 프로그램 개발(WCS)\n" +
    ...
    projectList: [
      {
        ...
        projectType: "신규",
        title:
          "LF Mall 브랜드몰 구축(마에스트로, 헤지스, 블루라운지, 라푸마) 프로젝트",
        period: "2019년 5월 ~ 2019년 12월",
        contritubtion:
          "PM: 1명, PL: 2명, PE: 2명(본인), 퍼블리셔: 1명\n" + "기여도: 30%",
        language: "Spring boot(1.3.5.RELEASE), JAVA, JavaScript, HTML5",
        db: "ORACLE(MyBatis)",
        management: "Git, Jenkins, Jira",
        description:
          "각 브랜드의 사이트들을 분석하여 결제 및 주문 페이지와 같은 공통 부분과 각 브랜드 사이트의 전시 및 상품 페이지를 분리하여 하나의 프로젝트로 통합 및 구축",
        role:
          "- LFMall 상품상세, 결제, 장바구니 페이지 병합\n" +
          "- API별 브랜드 이름 파라미터 추가\n" +
          "- 브랜드별 메인 페이지, Magazine\n" +
          "- 브랜드몰용 공용 DB 설계(Magazine, Content, Product, Menu)",
        result:
          "MAEMAESTRO, BLUEROUNGE, HAZZYS, LAFUMA 브랜드의 ADMIN, PWEB, MWEB 사이트 배포 및 운영",
      },
      {
        id: "ITM-NBOS",
        projectType: "구조개선",
        ...
        contribution:
          "PM: 1명, PL: 7명, PE: 2명(본인), 퍼블리셔: 1명\n" + "기여도: 20%",
        language: "Spring boot(1.3.5.RELEASE), JAVA, JavaScript, Nexacro17",
        db: "Oracle(mybatis)",
        management: "Git, Jenkins, Jira",
        description:
          "기존 struts, wise-grid, Oracle(ibatis)의 구조에서 Spring boot, Nexacro, Oracle(mybatis)의 구조로 개선 및 추가 관리자 페이지 구축, 기존 DB의 내부 Query와 프로시저 개선",
        role:
          "- 상품관리(품절관리, ep문구 관리, 벤더별 판매 비율, 촬영관리 )\n" +
    ...
    projectList: [
      {
        ...
        management: "Git",
        description:
          "사내 SMART CITY 프로그램에 사용자와 관리자의 통신을 위한 메신저 프로그램",
        role:
          "- RABBIT MQ 서버를 통한 메시지 QUEUE 설계, 개발\n" +
    ...
    projectList: [
      {
        ...
        management: "Git",
        description:
          "각 점포 별로 배부된 NFC 태그를 테이블마다 두어 핸드폰 어플로 테이블의 NFC 태그를 접촉하여 주문 및 다른 테이블로 메시지를 보낼 수 있는 시스템",
        role:
          "- POS 애플리케이션 개발(주문 확인, 메뉴 수정, 테이블별 정보)\n" +
...
const Home = () => {
  ...
  const companyProjectList = projectList.filter(
